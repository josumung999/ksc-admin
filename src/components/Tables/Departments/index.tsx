import DeleteDepartmentButton from "@/components/Forms/Departments/DeleteDepartmentButton";
import { UpdateDepartmentButton } from "@/components/Forms/Departments/UpdateDepartmentButton";
...
const DepartmentsTable: React.FC<DepartmentsTableProps> = ({ data }) => {
  return (
              ...
              <tr key={key} className="text-sm">
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div className="flex flex-row items-center space-x-2">
                    <UpdateDepartmentButton department={item} />
                    <DeleteDepartmentButton department={item} />
                  </div>
                </td>
              </tr>
            ))}
