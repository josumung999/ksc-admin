...
interface DeleteExerciceComptableProps {
  exerciceComptable: any;
}

const DeleteExerciceComptable: React.FC<DeleteExerciceComptableProps> = ({
  exerciceComptable,
}) => {
  ...
  async function deleteExerciceComptable() {
    try {
      setLoading(true);
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="">
        <AlertDialogHeader>
          <AlertDialogTitle>
            {" "}
            Etes vous sûr de vouloir supprimer cet exercice comptable?
          </AlertDialogTitle>
          <AlertDialogDescription>
...
export default DeleteExerciceComptable;
