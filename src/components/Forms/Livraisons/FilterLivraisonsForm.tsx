...
export type FilterLivraisonsFormData = z.infer<typeof FormSchema>;

interface FilterLivraisonsFormProps {
  driverIdFilter: string | undefined;
  setDriverIdFilter: (value: string | undefined) => void;
...
function FilterLivraisonsForm({
  ...
  drivers,
  setCurrentPage,
}: FilterLivraisonsFormProps) {
  const form = useForm<FilterLivraisonsFormData>({
  ...
  const onSubmit = (data: FilterLivraisonsFormData) => {
    setDriverIdFilter(data.driverId || undefined);
