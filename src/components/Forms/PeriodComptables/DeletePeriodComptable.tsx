...
interface DeletePeriodComptableProps {
  periodComptable: any;
}

const DeletePeriodComptable: React.FC<DeletePeriodComptableProps> = ({
  periodComptable,
}) => {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="">
        <AlertDialogHeader>
          <AlertDialogTitle>
            {" "}
            Etes vous sûr de vouloir supprimer cette période comptable?
          </AlertDialogTitle>
          <AlertDialogDescription>
...
export default DeletePeriodComptable;
